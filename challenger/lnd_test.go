...
// timeout expires. This is necessary because subscribeToInvoices runs in a
// goroutine and sets invoicesCancel on the challenger struct; calling
// c.Stop() before that goroutine has run would race on the invoicesCancel
// field. Returns true if the subscription was called, false on timeout.
